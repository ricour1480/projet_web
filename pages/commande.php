...
if (isset($_GET['confirmer_comm']) && isset($_SESSION['idcommande']) && isset($_SESSION['idclient']) && isset($_GET['prix'])) {
    ...
    ?><div class="white txtGras">Votre commande a été confirmer</div><?php
}
...
if (isset($_SESSION['idcommande']) && isset($_SESSION['idclient']) && isset($_GET['prix'])) {
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-3 txtGras white">Panier :<?php
                ...
                if (count($p) > 0) {
                    ...
                    for ($i = 0; $i < count($p); $i++) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-12"><span class="white txtGras">Prix:</span><span class="white"><?php print $p[$i]['SOMME_LIVRE']; ?></span></div>
                                </div>   
                            </div>
                        </div>
                        <?php
                    ...
                    ?>
                    <br/>
                    <button class="btn-primary" id="confirmer_comm" name="confirmer_comm">Confirmer</button>
                    <?php
                } else {
                    print "vide";
                }
